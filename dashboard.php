      ...
      <div class="wrapper">
         ...
         <div class="sidebar">
            <div class="sidebar-menu">
               ...
               <li class="item">
                  <a href="appointment_reg.php" class="menu-btn">
                  <i class="far fa-registered"></i><span>Reg Appointment</span>
                  </a>
               </li>
               <li class="item">
               ...
               <li class="item">
                  <a href="user_acc.php" class="menu-btn">
                  <i class="fas fa-user-alt"></i><span>User Accounts </span>
                  </a>
               </li>
               <li class="item">
                  <a href="user_info.php" class="menu-btn">
                  <i class="fas fa-info-circle"></i></i><span>User Information </span>
                  </a>
               </li>
               <hr>
               <li class="item ">
